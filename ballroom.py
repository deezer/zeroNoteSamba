...
if __name__ == '__main__':
    ...
    if (save == False):
        ...
        duplicates = ["Albums-AnaBelen_Veneo-11", "Albums-Fire-08", "Albums-Latin_Jam2-05", "Albums-Secret_Garden-01", \
                      "Albums-AnaBelen_Veneo-03", "Albums-Ballroom_Magic-03", "Albums-Latin_Jam-04", "Albums-Latin_Jam-08", \
                      "Albums-Latin_Jam-06", "Albums-Latin_Jam2-02", "Albums-Latin_Jam2-07", "Albums-Latin_Jam3-02", \
                      "Media-103402", "README"]

        al = ['ChaChaCha/', 'Jive/', 'Quickstep/', 'Rumba-American/', \
              'Rumba-International/', 'Rumba-Misc/', 'Samba/', 'Tango/', 'VienneseWaltz/', \
              'Waltz/']
