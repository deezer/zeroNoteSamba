...
def train_model(wavs, vqts, beat_pulse, real_beat_times, data_set, ymldict):
    ...
    percentages = [
        round(split_len * 0.01),
        round(split_len * 0.02),
        round(split_len * 0.05),
        round(split_len * 0.1),
        round(split_len * 0.2),
        round(split_len * 0.5),
        round(split_len * 0.75),
    ]
        ...
        for jj in range(10):
            ...
            if _status == "pretrained":
                ...
                state_dict = torch.load(
                    "models/saved/shift_pret_cnn_16.pth",
            ...
            for _ in trange(500):
                ...
                val_f_measure, val_cmlc, val_cmlt, val_amlc, val_amlt, val_info_gain = (
                    0.0,
                    0.0,
                    0.0,
                    0.0,
